...
Contacts.prototype = {
  ...
  enterContactDetails: function(details) {
    ...
    var save = this.waitForEnabledElement(selectors.formSave);
    save.click();
  ...
  addContact: function(details) {
    ...
    var addContact = this.waitForEnabledElement(selectors.formNew);
    addContact.click();
  ...
  waitForEnabledElement: function(selector) {
    var element = this.client.helper.waitForElement(selector);
    var test = function() {
